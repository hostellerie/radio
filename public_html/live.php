...
$js = '<script>(function(){'
    ...
    . 'if(!data.now_playing){program.textContent="";media.textContent="";status.textContent=' . json_encode($LANG_RADIO['nothing_scheduled_now']) . ';return;}'
    . 'program.textContent=data.now_playing.title;'
