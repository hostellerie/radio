...
if ($canEdit) {
    $content .= '<div class="radio-studio__player-meta">'
        ...
        . '<button type="button" class="radio-admin__button radio-studio__djmode-button" data-radio-djmode-open>'
        . radio_studio_h($LANG_RADIO['studio_djmode_open']) . '</button>'
        ...
        . '<label class="radio-studio__djfx-control"><span class="radio-studio__djfx-control-head"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_low']) . '</span><output data-radio-djfx-value="low">0 dB</output></span>'
        . '<input type="range" min="-12" max="12" value="0" step="1" data-radio-djfx="low"></label>'
        . '<label class="radio-studio__djfx-control"><span class="radio-studio__djfx-control-head"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_mid']) . '</span><output data-radio-djfx-value="mid">0 dB</output></span>'
        . '<input type="range" min="-12" max="12" value="0" step="1" data-radio-djfx="mid"></label>'
        . '<label class="radio-studio__djfx-control"><span class="radio-studio__djfx-control-head"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_high']) . '</span><output data-radio-djfx-value="high">0 dB</output></span>'
        . '<input type="range" min="-12" max="12" value="0" step="1" data-radio-djfx="high"></label>'
        . '<label class="radio-studio__djfx-control"><span class="radio-studio__djfx-control-head"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_filter']) . '</span><output data-radio-djfx-value="filter">0</output></span>'
        . '<input type="range" min="-100" max="100" value="0" step="1" data-radio-djfx="filter"></label>'
        . '<button type="button" class="radio-admin__button radio-studio__djfx-effect" data-radio-djfx-button="echo" aria-pressed="false">'
        . radio_studio_h($LANG_RADIO['studio_djfx_echo']) . '</button>'
        . '<button type="button" class="radio-admin__button radio-studio__djfx-effect" data-radio-djfx-button="reset">'
        . radio_studio_h($LANG_RADIO['studio_djfx_reset']) . '</button>'
        . '</div>'
        . '<div class="radio-studio__djfx-pad-title">' . radio_studio_h($LANG_RADIO['studio_djfx_pads_title']) . '</div>'
        . '<div class="radio-studio__djfx-pads" data-radio-djfx-pads>'
        . '<div class="radio-studio__djfx-pad" data-radio-djfx-pad="1">'
        . '<button type="button" class="radio-studio__djfx-pad-trigger" data-radio-djfx-pad-play="1"><strong data-radio-djfx-pad-label="1">PAD 1</strong><span>' . radio_studio_h($LANG_RADIO['studio_djfx_pad_play']) . '</span></button>'
        . '<select aria-label="' . radio_studio_h($LANG_RADIO['studio_djfx_pad_assign']) . ' 1" data-radio-djfx-pad-select="1">' . $jingleOptions . '</select>'
        . '</div>'
        . '<div class="radio-studio__djfx-pad" data-radio-djfx-pad="2">'
        . '<button type="button" class="radio-studio__djfx-pad-trigger" data-radio-djfx-pad-play="2"><strong data-radio-djfx-pad-label="2">PAD 2</strong><span>' . radio_studio_h($LANG_RADIO['studio_djfx_pad_play']) . '</span></button>'
        . '<select aria-label="' . radio_studio_h($LANG_RADIO['studio_djfx_pad_assign']) . ' 2" data-radio-djfx-pad-select="2">' . $jingleOptions . '</select>'
        . '</div>'
        . '<div class="radio-studio__djfx-pad" data-radio-djfx-pad="3">'
        . '<button type="button" class="radio-studio__djfx-pad-trigger" data-radio-djfx-pad-play="3"><strong data-radio-djfx-pad-label="3">PAD 3</strong><span>' . radio_studio_h($LANG_RADIO['studio_djfx_pad_play']) . '</span></button>'
        . '<select aria-label="' . radio_studio_h($LANG_RADIO['studio_djfx_pad_assign']) . ' 3" data-radio-djfx-pad-select="3">' . $jingleOptions . '</select>'
        . '</div>'
        . '<div class="radio-studio__djfx-pad" data-radio-djfx-pad="4">'
        . '<button type="button" class="radio-studio__djfx-pad-trigger" data-radio-djfx-pad-play="4"><strong data-radio-djfx-pad-label="4">PAD 4</strong><span>' . radio_studio_h($LANG_RADIO['studio_djfx_pad_play']) . '</span></button>'
        . '<select aria-label="' . radio_studio_h($LANG_RADIO['studio_djfx_pad_assign']) . ' 4" data-radio-djfx-pad-select="4">' . $jingleOptions . '</select>'
        . '</div>'
        . '</div>'
        . '<small class="radio-admin__muted">' . radio_studio_h($LANG_RADIO['studio_djfx_help']) . '</small>'
        . '</section>'
        . '<section class="radio-studio__djmode" data-radio-djmode aria-hidden="true">'
        . '<header class="radio-studio__djmode-header">'
        . '<div><strong>' . radio_studio_h($program['title']) . '</strong><span class="radio-studio__djmode-live" data-radio-djmode-live></span></div>'
        . '<button type="button" class="radio-studio__djmode-exit" data-radio-djmode-close>'
        . radio_studio_h($LANG_RADIO['studio_djmode_close']) . '</button>'
        . '</header>'
        . '<div class="radio-studio__djmode-scope"><canvas width="1400" height="180" data-radio-djfx-scope></canvas></div>'
        . '<div class="radio-studio__djmode-main">'
        . '<div class="radio-studio__djmode-faders">'
        . '<label class="radio-studio__djmode-fader"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_low']) . '</span><output data-radio-djmode-value="low">0 dB</output><input type="range" min="-12" max="12" step="1" value="0" data-radio-djmode-fx="low"></label>'
        . '<label class="radio-studio__djmode-fader"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_mid']) . '</span><output data-radio-djmode-value="mid">0 dB</output><input type="range" min="-12" max="12" step="1" value="0" data-radio-djmode-fx="mid"></label>'
        . '<label class="radio-studio__djmode-fader"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_high']) . '</span><output data-radio-djmode-value="high">0 dB</output><input type="range" min="-12" max="12" step="1" value="0" data-radio-djmode-fx="high"></label>'
        . '<label class="radio-studio__djmode-fader"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_filter']) . '</span><output data-radio-djmode-value="filter">0</output><input type="range" min="-100" max="100" step="1" value="0" data-radio-djmode-fx="filter"></label>'
        . '</div>'
        . '<div class="radio-studio__djmode-actions">'
        . '<button type="button" data-radio-djmode-button="echo" aria-pressed="false">' . radio_studio_h($LANG_RADIO['studio_djfx_echo']) . '</button>'
        . '<button type="button" data-radio-djmode-button="reset">' . radio_studio_h($LANG_RADIO['studio_djfx_reset']) . '</button>'
        . '</div>'
        . '</div>'
        . '<div class="radio-studio__djmode-pads">'
        . '<button type="button" data-radio-djmode-pad="1"><strong data-radio-djmode-pad-label="1">PAD 1</strong></button>'
        . '<button type="button" data-radio-djmode-pad="2"><strong data-radio-djmode-pad-label="2">PAD 2</strong></button>'
        . '<button type="button" data-radio-djmode-pad="3"><strong data-radio-djmode-pad-label="3">PAD 3</strong></button>'
        . '<button type="button" data-radio-djmode-pad="4"><strong data-radio-djmode-pad-label="4">PAD 4</strong></button>'
        . '</div>'
        . '<footer class="radio-studio__djmode-footer">'
        . '<div class="radio-studio__djmode-now"><span>' . radio_studio_h($LANG_RADIO['studio_djmode_now']) . '</span><strong data-radio-djmode-now></strong><small data-radio-djmode-time></small></div>'
        . '<div class="radio-studio__djmode-next"><span>' . radio_studio_h($LANG_RADIO['studio_djmode_next']) . '</span><strong data-radio-djmode-next>—</strong></div>'
        . '<div class="radio-studio__djmode-next"><span>' . radio_studio_h($LANG_RADIO['studio_djmode_reserve']) . '</span><strong data-radio-djmode-reserve>—</strong></div>'
        . '</footer>'
        . '</section>';
}
