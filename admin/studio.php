...
if ($canEdit) {
    $content .= '<div class="radio-studio__player-meta">'
        ...
        . '<button type="button" class="radio-admin__button radio-studio__djfx-effect" data-radio-djfx-button="headroom" aria-pressed="false">'
        . radio_studio_h($LANG_RADIO['studio_djfx_headroom']) . '</button>'
