...
if ($canEdit) {
    $studioAttrs = ' data-radio-studio'
        ...
        . ' data-buffer-current-label="' . radio_studio_h($LANG_RADIO['studio_buffer_current']) . '"'
        . ' data-buffer-remaining-label="' . radio_studio_h($LANG_RADIO['studio_buffer_remaining']) . '"'
...
if ($canEdit) {
    $content .= '<div class="radio-studio__player-meta">'
        ...
        . '<div class="radio-studio__djfx-scope"><canvas width="1400" height="180" data-radio-djfx-scope></canvas></div>'
        ...
        . '<input type="range" min="-12" max="12" value="0" step="1" data-radio-djfx="low">'
        . '<span class="radio-studio__djfx-pushes">'
        . '<button type="button" data-radio-djfx-push="low" data-radio-djfx-push-value="-10">−10 dB</button>'
        . '<button type="button" data-radio-djfx-push="low" data-radio-djfx-push-value="10">+10 dB</button>'
        . '</span></label>'
        ...
        . '<input type="range" min="-12" max="12" value="0" step="1" data-radio-djfx="mid">'
        . '<span class="radio-studio__djfx-pushes">'
        . '<button type="button" data-radio-djfx-push="mid" data-radio-djfx-push-value="-10">−10 dB</button>'
        . '<button type="button" data-radio-djfx-push="mid" data-radio-djfx-push-value="10">+10 dB</button>'
        . '</span></label>'
        ...
        . '<input type="range" min="-12" max="12" value="0" step="1" data-radio-djfx="high">'
        . '<span class="radio-studio__djfx-pushes">'
        . '<button type="button" data-radio-djfx-push="high" data-radio-djfx-push-value="-10">−10 dB</button>'
        . '<button type="button" data-radio-djfx-push="high" data-radio-djfx-push-value="10">+10 dB</button>'
        . '</span></label>'
        . '<div class="radio-studio__djfx-control radio-studio__djfx-filter-control">'
        . '<span class="radio-studio__djfx-control-head"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_filter']) . '</span><output data-radio-djfx-value="filter">0</output></span>'
        . '<input type="range" min="-100" max="100" value="0" step="1" data-radio-djfx="filter">'
        . '<div class="radio-studio__djfx-pan-inline">'
        . '<span class="radio-studio__djfx-control-head"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_pan']) . '</span><output data-radio-djfx-value="pan">C</output></span>'
        . '<span class="radio-studio__djfx-spring radio-studio__djfx-pan">'
        . '<span aria-hidden="true">L</span>'
        . '<input type="range" min="-100" max="100" value="0" step="1"'
        . ' data-radio-djfx-spring="pan" aria-label="' . radio_studio_h($LANG_RADIO['studio_djfx_pan']) . '">'
        . '<span aria-hidden="true">R</span>'
        . '</span></div></div>'
        . '<label class="radio-studio__djfx-control radio-studio__djfx-headroom-control">'
        . '<span class="radio-studio__djfx-control-head"><span>' . radio_studio_h($LANG_RADIO['studio_djfx_headroom']) . '</span><output data-radio-djfx-value="headroom">0 dB</output></span>'
        . '<input type="range" min="-10" max="10" value="0" step="1" data-radio-djfx="headroom">'
        . '</label>'
        . '<div class="radio-studio__djfx-actions">'
